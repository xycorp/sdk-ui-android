 ...
 * @author amit
 */
class VerticalOverScrollBounceEffectDecorator
/**
 ...
 * bounce-back effect.
 */
@JvmOverloads constructor(viewAdapter: IOverScrollDecoratorAdapter,
                          touchDragRatioFwd: Float = DEFAULT_TOUCH_DRAG_MOVE_RATIO_FWD, touchDragRatioBck: Float = DEFAULT_TOUCH_DRAG_MOVE_RATIO_BCK, decelerateFactor: Float = DEFAULT_DECELERATE_FACTOR) : OverScrollBounceEffectDecoratorBase(viewAdapter, decelerateFactor, touchDragRatioFwd, touchDragRatioBck) {

    private class MotionAttributesVertical : MotionAttributes() {

        override fun initialize(view: View, event: MotionEvent): Boolean {
