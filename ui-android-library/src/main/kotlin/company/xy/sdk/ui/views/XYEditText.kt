...
open class XYEditText @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) :
    ...
    open fun setImeVisibility(visible: Boolean) {
        if (visible) {
